				...
				<div class="box span12">
					...
					<div class="page-header" ></div>
						...
						<div class="control-group">
								...
								<div class="controls">
								 <input name="id" class="input-xlarge"  type="hidden" value="${tables.id}">
								  <span  class="input-xlarge uneditable-input ">${tables.id}</span>
								</div>
							  </div>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input name="ord_id" class="input-xlarge focused" id="Orderid" type="text" value="${tables.ord_id}">
								</div>
							  </div>
							  <div class="control-group">
								<label class="control-label" for="num">人  数</label>
								<div class="controls">
								  <input name="num" class="input-xlarge focused" id="num" type="text" value="${tables.num}">
								</div>
							  </div>
							  <div class="control-group">
								<label class="control-label" for="desc">描  述</label>
								<div class="controls">
								  <input name="description" class="input-xlarge focused" id="desc" type="text" value="${tables.description}">
								</div>
							  </div>
							  <div class="control-group info">
								<label class="control-label" for="tflag">餐桌状态</label>
								<div class="controls">
								  <input name="flag" class="input-xlarge focused" id="tflag" type="text" value="${tables.flag}">
								  <span class="help-inline">"1"表示空闲 , "0"表示满座</span>
								</div>
							  </div>						
							<div class="form-actions">
								<button type="submit" class="btn btn-primary">保  存</button>
								<a href="${pageContext.request.contextPath }/tableServlet?pageNow=${pageNow}">
